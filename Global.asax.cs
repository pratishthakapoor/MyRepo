        ...
        protected void Application_Start()
        {
            ...
            Conversation.UpdateContainer(
                builder =>
                {
                    ...
                    // var store = new TableBotDataStore(ConfigurationManager.ConnectionStrings["AzureTableStorage"].ConnectionString); // requires Microsoft.BotBuilder.Azure Nuget package 
